...
<div class="footer-inner section-inner<?php echo esc_attr( $footer_inner_classes ); ?>">
  ...
  <div class="footer-logos">
    <img class="dcc-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/images/dcc-logo.svg" alt="Dunedin City Council logo" />
    <img class="cogs-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/images/cogs-logo.png" alt="COGS logo" />
    <img class="lotto-nz-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/images/nz-lottery.svg" alt="Lotto NZ logo" />
  </div><!-- .footer-logos -->
